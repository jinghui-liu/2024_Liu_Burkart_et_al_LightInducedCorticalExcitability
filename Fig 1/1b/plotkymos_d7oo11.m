...
dir = 'save_kymocurvextract_d7oo11wt_20220910 22_19';

load([dir '/boundary.mat'],'bws');
...
colormap(colorcet('L05'));
% daspect([7,1,1]);

caxis([-3 9]);

% fig_current = gcf; fig_current.Renderer = 'painters';
% print(fig_current,['kymo_' filename 'ROI1_cetL05'],'-dpdf');
