...
load(['curvs_updated/curvs_' filename '.mat'],'curvs');
...
load('curvs_interp_shiftVP0_d5oo1_t1.mat','curvs_interp_shiftVP0');

figure;
imagesc(taxis,phis_interpcor,(curvs_interp_shiftVP-curvs_interp_shiftVP0(:,1))./umperpix);cbh = colorbar;hold on; % in inverse micron
...
curv_plotted = (curvs_interp_shiftVP-curvs_interp_shiftVP0(:,1))./umperpix;
...
% imArr = readfromtiff('d5oo1_t2',t_total,512,512);
...
for t = 40:1:40 % 1:lag_frame:size(imArr,3) % 242,253,264
